...
public class CreateAccountResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this CreateAccountResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this CreateAccountResponse.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.account.talk", ">createAccountResponse"));
