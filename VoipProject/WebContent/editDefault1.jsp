<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.List, util.Nation,util.Contact,javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, javax.servlet.http.HttpSession, talk.account.service.xsd.WebContact, talk.calling.service.xsd.NationalCode, util.Utility "%>
...
function deleteDefaultContact(){
	alertify.set({ labels : { ok: "確定", cancel: "取消" } });
	alertify.confirm("確定要刪除預設聯絡人嗎?", function (e) {
	    if (e) {
	        // user clicked "ok"
...
<body>
	...
	<div class="content">
		<%
		Contact contact = (Contact)session.getAttribute("editDefaultContact");
		%>
		...
		<div class="content1">
			...
			<div class="content-form">
				<div class="content-delete-contact">
					<a href="#" onclick="deleteDefaultContact()">
						<img src="img/web/delete_default.png" height="35px" width="150px">
					</a>
				</div>
            	...
            	%>
            		<input type="hidden" id="ncode" name="ncode" value="">
            		<div>
            			<div id="ncodedisplay" style="display:block;"><%=precode %></div>
