			...
			<table id="table1">
				...
				<tr>
					...
					<% 
						...
						BigDecimal bd = new BigDecimal(Double.toString(userCurrentPoint));
				        bd = bd.setScale(1, BigDecimal.ROUND_HALF_UP);
						String totalcost = String.valueOf(bd.floatValue());
					%>
					<%=userLimitPoint %>
					</td>
					<td align="right"><%=userCostPoint %></td>	
					<td align="right"><%=userCurrentPoint %></td>
				</tr>
			</table>
			</div>
		</div>
