<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="util.SubUser,javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, javax.servlet.http.HttpSession, talk.account.service.xsd.WebAccount"%>
...
function formsubmit(){
	...
	if(subUserForm.pointlimit.value == ""){
...
<body >
	...
	<div class="content">
	<% SubUser account = (SubUser)session.getAttribute("subUserAccount"); %>
		...
		<div class="section1">
			<form id="subUserForm" class="bs-docs-example form-horizontal" method="post" onsubmit="return check(this)" action="webSubUser.do">
            	...
            	<div class="input-group-lg section1-email">
              		<input type="text" class="form-control input-lg" style="border:1px solid #611987" value="<%=account.getRegMail() %>" id="useremail1" name="useremail1" maxLength="40" placeholder="請輸入附屬帳號之電子郵件信箱" required>
            	</div>
            	<div class="section1-text">
            		使用人名稱 :
            	</div>
            	<div class="input-group-lg section1-email">
              		<input type="text" class="form-control input-lg" style="border:1px solid #611987" value="<%=account.getName() %>" id="username" name="username" maxLength="40" placeholder="請輸入附屬帳號之使用人名稱" required>
            	</div>
            	<div class="section1-text">
            		授權點數上限 :
            	</div>
            	<div class="input-group-lg section1-email">
              		<input type="text" class="form-control input-lg" style="border:1px solid #611987" id="pointlimit" name="pointlimit" value="<%=request.getAttribute("limit") %>" onkeyup="value=value.replace(/[^-_A-Z0-9]/g,'')" maxLength="10" placeholder="請輸入附屬帳號之授權點數上限" required>
            	</div>
		...
		<div class="section2">
			<div class="sub-btn">
            	<div class="sub-btn-btn">
            		<a href="javascript: return false;" onclick="formsubmit()"><img src="img/web/save_btn.png" height="70px" width="70px"></a>
            	</div>
           	</div>
		</div>
	</div>
