<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, java.util.ArrayList, talk.account.service.xsd.WebContact "%>
...
<div id="content_column">
	<div class="content">
		...
		WebContact contact = (WebContact)session.getAttribute("editContact");
		%>
			...
			<div class="sec1_text">
				<span class="label label-success"><h4>編輯聯絡人</h4></span>
				<form id="contactForm" class="bs-docs-example form-horizontal" method="post" onsubmit="return check(this)" action="contact.do" enctype="multipart/form-data">
            		...
            		<div class="control-group">
                		<button class="btn btn-primary" type="submit" >確定</button>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="editMode()" class="btn btn-default" type="button">取消</a>
                		&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="btn btn-default" onclick="deleteContact()">刪除</a>
           			</div>
