...
<div id="content_column">
	<div class="content">
		...
		<div class="section1">
			<div class="sec1_text">
				<span class="label label-success"><h4>新增聯絡人</h4></span>
				<form id="contactForm" class="bs-docs-example form-horizontal" method="post" onsubmit="return check(this)" action="contact.do" enctype="multipart/form-data">
            		...
            		<div class="input-group input-group-lg">
              			行動電話號碼:&nbsp;
                		<input type="text" class="form-control input-lg" id="mobile" onkeyup="value=value.replace(/[^-_A-Z0-9]/g,'')" maxLength="10" name="mobile" placeholder="請輸入行動電話號碼">
            		</div>
            		<div class="input-group input-group-lg">
              			分機號碼:&nbsp;
            		...
            		<div class="control-group">
                		<button class="btn btn-primary" type="submit" >確定</button>&nbsp&nbsp&nbsp&nbsp<a href="contact.do" class="btn btn-default" type="button">取消</a>
           			</div>
