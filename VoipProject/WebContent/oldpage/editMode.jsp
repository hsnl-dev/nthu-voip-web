...
<form name="contactForm" id="contactForm" method="post" action="default.do">
	<table width="100%" >
		<tr><td><h4><strong><%=depart %> - 聯絡人管理</strong></h4></td></tr>
		<tr><td>
		<ul id="items">
	<%
		...
		if(request.getAttribute("allContactList") != null){
			...
			for(int i = 0; i < allContactList.size(); i++){
				WebContact contact = (WebContact)allContactList.get(i);
				defaultFlag = false;
				if(defaultList != null){
					for(int j = 0; j < defaultList.length; j++){
						if(contact.getUUID().equals(defaultList[j].getUUID())){
							defaultFlag = true;
							break;
						}
					}
                    	...
                    	<div class="div_outer">
                    		...
                    		<div class="div_phone">
                    			...
                    			<% }else{ %>
                    				<a href="#" class="btn btn-block" >
                    			<% } %>
                    				<img src="img/phone.png" width="14px" height="14px"><br><%=contact.getMobilePhone() %>
                    				</a>
                    			</div>
                    		</div>
                    	</div>
...
<td align="center" valign="top" width="20%">
	<div class="text">
		...
		<ul>
			<li><p><img src="img/right-arrow.png">&nbsp;點擊黃色聯絡人頭像可以開始進行編輯。</p></li>
