...
function check(contactForm){
	if(contactForm.inputPassword.value != contactForm.inputPassword2.value){
...
<div id="content_column">
    ...
    <td width="70%">
                             請輸入新的密碼:<br>
        <input type="password" name="inputPassword" id="inputPassword" size="20" maxLength="10" value="" placeholder="請輸入新的密碼" required>
    </td>
    </tr>
    <tr>
    <td width="30%"></td>
    <td width="70%">
                             請再一次輸入密碼:<br>
        <input type="password" name="inputPassword2" id="inputPassword2" size="20" maxLength="10" value="" placeholder="請再一次輸入密碼" required>
    </td>
    </tr>
    <tr>
    <td></td>
    <td><button class="btn btn-primary" type="submit" >儲存</button>
    <input type="hidden" name="action" id="action" value="changePassword"/></td>
    </tr>
    </table>
    </form>
  	</div>
