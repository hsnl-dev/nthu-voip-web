...
<div id="wrap">
	...
	<div class="content">
		<div class="content_left">
			<p class="content_title">附屬帳號使用者</p>
			<ol class="content_text" type="1">
				<li>請自行向各單位管理者申請建立附屬帳號。</li>
				<li>經單位管理者建立帳號完成，附屬帳號使用者會收到由清華大學雲端網路電話服務中心寄來的<font color="red"> e-mail 驗證信件</font>，</li>
				<li>通過驗證後即可登入附屬帳號網頁享受服務囉!</li>
			</ol>
			<br>
			<p class="content_subtitle">功能說明</p>
			<ul class="content_text">
				<li>「<font color="#428bca">附屬帳號</font>」功能 : <br>附屬帳號使用者可指派/維護多位附屬帳號，並且分配/查看附屬帳號點數。</li>
				<li>「<font color="#428bca">聯絡人</font>」功能 : <br>聯絡人為個人聯絡人名單，附屬帳號使用者可新增/修改名單。</li>
			</ul>
		</div>
		<div class="content_right">
			<p><a href="Home1.jsp"><img src="img/loginicon.png" height="33px" width="70px"></a></p>
			<p><a href="web.html?action=apply"><img src="img/web/apply_account.png" height="28px" width="100px"></a></p>
		</div>
	</div>
	<div class="footer">
