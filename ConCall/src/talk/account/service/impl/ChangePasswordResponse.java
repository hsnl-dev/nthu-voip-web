...
public class ChangePasswordResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this ChangePasswordResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this ChangePasswordResponse.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.account.talk", ">changePasswordResponse"));
