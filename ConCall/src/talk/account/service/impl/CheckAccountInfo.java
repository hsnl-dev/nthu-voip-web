...
public class CheckAccountInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the number value for this CheckAccountInfo.
     * 
     * @return number
     */
    ...
    /**
     * Sets the number value for this CheckAccountInfo.
     * 
     * @param number
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.account.talk", ">checkAccountInfo"));
