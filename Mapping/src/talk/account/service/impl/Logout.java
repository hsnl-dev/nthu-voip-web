...
public class Logout  implements java.io.Serializable {
    ...
    /**
     * Gets the session value for this Logout.
     * 
     * @return session
     */
    ...
    /**
     * Sets the session value for this Logout.
     * 
     * @param session
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.account.talk", ">logout"));
